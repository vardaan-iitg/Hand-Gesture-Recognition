...
class Application:
    def __init__(self):
        ...
        self.json_file = open("C:/Users/DELL/Downloads/model-bw.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights("C:/Users/DELL/Downloads/model-bw.h5")

        self.json_file_dru = open("C:/Users/DELL/Downloads/model-bw_dru.json" , "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights("C:/Users/DELL/Downloads/model-bw_dru.h5")

        self.json_file_tkdi = open("C:/Users/DELL/Downloads/model-bw_tkdi.json" , "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights("C:/Users/DELL/Downloads/model-bw_tkdi.h5")

        self.json_file_smn = open("C:/Users/DELL/Downloads/model-bw_smn.json" , "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights("C:/Users/DELL/Downloads/model-bw_smn.h5")
    ...
    def action_call(self) :
        ...
        self.tx1 = tk.Label(self.root1)
        self.tx2 = tk.Label(self.root1)
        self.tx3 = tk.Label(self.root1)
        self.tx4 = tk.Label(self.root1)
        
        self.tx.place(x = 330,y = 20)
        self.tx1.place(x = 10,y = 120)
        self.tx2.place(x = 10,y = 220)
        self.tx3.place(x = 10,y = 320)
        self.tx4.place(x = 10,y = 420)
        
        self.tx.config(text = "Efforts By-", fg="red", font = ("Courier",30,"bold"))
        self.tx1.config(text = "Yashi Agarwal- Group Member 1", fg="blue", font = ("Courier",30,"bold"))
        self.tx2.config(text = "Riya Sahu - Group Member 2", fg="red", font = ("Courier",30,"bold"))
        self.tx3.config(text = "Sejal Agrawal - Group Member 3", fg="green", font = ("Courier",30,"bold"))
        self.tx4.config(text = "Suyash Khare- Group Member 4", fg="blue", font = ("Courier",30,"bold"))
